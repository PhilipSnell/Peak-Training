...
(function($) {
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            var to_box = quickElement('select', selector_chosen, '', 'id', field_id + '_to', 'multiple', 'multiple', 'size', from_box.size, 'nav.css', from_box.getAttribute('nav.css'));
            ...
            from_box.setAttribute('nav.css', from_box.getAttribute('nav.css') + '_old');
